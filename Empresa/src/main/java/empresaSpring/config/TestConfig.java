...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String...args) throws Exception{
        ...
        Cargo cargo1 = new Cargo(null,"Representante Comercial","Vendedor externo");
        Cargo cargo2 = new Cargo(null,"Gerente geral","Gerencia Equipe de todos setores");
        Cargo cargo3 = new Cargo(null,"Gerente Financeiro","Gerencia financas da empresa");
        cargoRepository.saveAll(Arrays.asList(cargo1,cargo2,cargo3));

        Colaborador colaborador1 = new Colaborador(null,"Joao Freitas","235.541.486-58", LocalDate.parse("1987-01-26"));
        Colaborador colaborador2 = new Colaborador(null,"Patricia Almeida","147.963.258-05",LocalDate.parse("1983-06-14"));
        Colaborador colaborador3 = new Colaborador(null,"Suzane Goncalves","596.254.002-90",LocalDate.parse("1992-12-28"));
